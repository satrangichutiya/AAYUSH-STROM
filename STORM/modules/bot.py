...
TEXT += f"**• ɢʀᴏᴜᴘ 💫: [ɢʀᴏᴜᴘ 🥀](https://t.me/HOD_AYUSH_PYROGRAM_CLIENT)**\n"
TEXT += f"**• ᴄʜᴀɴɴᴇʟ ✨: [ᴄʜᴀɴɴᴇʟ 🥀](https://t.me/HOD_AYUSH_PYROGRAM_CLIENT)**\n"
...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        ...
        await KEX.edit(f"ʙᴀᴀᴘ ᴘᴀʀ ʀᴀɪᴅ ɴᴀʜɪ ᴋʀᴛᴇ ʙꜱᴅᴋ ⚡\n» `{mp} ᴍꜱ`") 
